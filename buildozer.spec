...
#requirements = python3,kivy==2.3.0,typing_extensions,bleak,requests,pyjnius,pyble,plyer,android
requirements = python3, kivy==2.3.0, bleak, asyncio, android, pyjnius, typing_extensions,pyble
...
android.permissions = INTERNET,BLUETOOTH, BLUETOOTH_ADMIN, ACCESS_FINE_LOCATION, ACCESS_COARSE_LOCATION, BLUETOOTH_SCAN, BLUETOOTH_CONNECT
...
# OUYA-ODK/libs/*.jar
#android.add_jars = /mnt/c/user/ottoMA/com/github/hbldh/bleak/bluetooth_function.jar
android.add_jars = /home/openonevm/kivybtwlanNgagne/bulldozer/bleak/bluetooth_function.jar
